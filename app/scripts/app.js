...
$scope.SubscribeClick = function($event) {
$rootScope.Subscribe.Event = $event;

$scope.openWindow("https://bit.ly/392pNmp", "", "");
...
$scope.openWindow("https://brilliant-tech.github.io/Brilliant-Tech", "", "");
